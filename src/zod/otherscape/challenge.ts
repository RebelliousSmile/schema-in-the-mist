...
export const MetaSchema = createPublicationMetaSchema({
  publicationDescription: "Classifies the Challenge's source to aid cataloging and tooling.",
  publicationExamples: ["official", "homebrew"],
  sourceDescription: "Source title (book, supplement, PDF) where this Challenge appears.",
  sourceExamples: [
          "Metro:Otherscape - Core Book",
          "Tokyo:Otherscape - Setting Book",
        ],
  pageExamples: [212, 268],
