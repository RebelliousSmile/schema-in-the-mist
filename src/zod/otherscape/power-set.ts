...
export const MetaSchema = createPublicationMetaSchema({
  publicationDescription: "Classifies the Power Set's source to aid cataloging and tooling.",
  publicationExamples: ["official", "homebrew"],
  sourceDescription: "Source title (book, supplement, PDF) where this Power Set appears.",
  sourceExamples: [
          "Metro:Otherscape - Core Book",
          "Cairo:Otherscape - Playtest",
        ],
  pageExamples: [224, 231],
