...
export const MetaSchema = createPublicationMetaSchema({
  publicationDescription: "Classifies the move's source to aid cataloging and tooling.",
  publicationExamples: ["official", "cauldron"],
  sourceDescription: "Source title (book, supplement, PDF) where this move appears.",
  sourceExamples: [
          "City of Mist: MC Toolkit",
          "City of Mist: Player's Guide",
          "Danger Workbook",
        ],
  pageExamples: [134, 137, 191],
  description: "Attribution and cataloging fields for the custom move's origin.",
});
