...
- Publish the versioned cross-tool provider descriptor and the Handbook packs it declares in the release tarball, with public package exports for both paths.
- Remove historical release archives and checksums from Git; immutable GitHub Releases remain the distribution channel.

## [v1.3.2] - 2026-09-18

### Changed

- Publish the Codex execution and complete-release rules that govern main-branch work and immutable package releases.
...
- The City of Mist pack now publishes a scoped stylesheet for its heading,
  link, and component typography layer.

## [v1.1.0] - 2026-09-15

### Added

- Let Handbook game packs declare ordered, normalized stylesheet resources under `pack.assets.stylesheets`; validate their safe paths and complete asset inventory while retaining token-only pack compatibility.
