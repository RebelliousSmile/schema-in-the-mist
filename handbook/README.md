...
The former Son of Oak PNG theme cards and PragRoman font are no longer published. The pack uses original replacement WebP card art and its already published OFL-licensed Labrada WOFF2 face instead. This is the package's explicit redistribution decision: disputed source media are not part of the npm distribution.
